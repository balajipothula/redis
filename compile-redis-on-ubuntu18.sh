...
# nohup redis-server $HOME/redis/conf/redis.conf &

# connecting to redis server.
# redis-cli -h 127.0.0.1 -p 6379 -a password PING Hi..!
...
cd       $HOME                                                                     && \
cp       $HOME/redissrc/redis.conf $HOME/redis/bin                                 && \
touch    $HOME/redis/bin/{redis.log,redis.pid}                                     && \
